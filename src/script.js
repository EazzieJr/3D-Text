...
fontLoader.load(
    ...
    (font) => {
        ...
        const donutGeometry = new THREE.TorusBufferGeometry(0.35, 0.15, 20, 45)
        const cubeGeometry = new THREE.BoxBufferGeometry(0.2, 0.2, 0.2, 50, 50)
        const starGeometry = new THREE.OctahedronBufferGeometry(0.15, 0)
